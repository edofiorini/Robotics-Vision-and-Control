%% 3D Path - linear and circular motion primitives- p(u)
% Compute the path p(s) as the composition of two different primitivies
% there is not the time constraint
...
% We have all the function call explicit
...
plot3(C(1,:), C(2,:), C(3,:),'*', 'MarkerSize',12)
hold on;
p = plot3(Q(1,:), Q(2,:), Q(3,:));
p.LineWidth = 5;
